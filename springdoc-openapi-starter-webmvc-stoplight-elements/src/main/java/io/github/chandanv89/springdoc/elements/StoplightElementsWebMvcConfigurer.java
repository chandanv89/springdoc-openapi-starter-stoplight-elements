...
/**
 * Configures Spring MVC resource handlers to serve the bundled Stoplight Elements JS and CSS files.
 *
 ...
 */
public class StoplightElementsWebMvcConfigurer implements WebMvcConfigurer {
